  ...
  String _getAnswer(String question) {
    final answers = {
      ...
      'How to return an item?':
          ...
          '4. Select the reson for retutn \n'
          '5. Print the return label \n'
          '6. Pack the item securely\n'
          '6. Drop off the package at the nearest shipping location \n\n'
          'Returns must be initiated within  30 days of dalivery. Once we receive the item,your refound will be process',
    };
